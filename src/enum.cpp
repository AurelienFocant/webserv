...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/01/07 17:20:03 by stempels          #+#    #+#             */
/*   Updated: 2026/01/07 17:50:24 by stempels         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
std::string progressToString(t_progress code)  {
	switch (code) {
		...
		case METHOD:						return "Method processed";
		case URI:							return "URI processed";
		case VERSION:						return "Http version processed";
		case FIRST_LINE:					return "First line processed";
		case PARSED:						return "Headers parsed";
		case BODY_HANDLING:					return "Processing body";
		case DONE:							return "Process ended";
...
t_progress	progressFromString(const std::string& s)  {
	...
	else if	(s == "URI")					return URI;
	else if	(s == "VERSION")				return VERSION;
	else if	(s == "FIRST_LINE")				return FIRST_LINE;
	else if	(s == "PARSED")					return PARSED;
	else if	(s == "BODY_HANDLING")			return BODY_HANDLING;
